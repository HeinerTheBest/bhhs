...
class MockDataBase
{
    fun getHouses(): ArrayList<ShowHousesViewModel> {
        ...
        val house2 = House("2", "$399,900", null,"1590 Arden Drive SW Marietta, GA 30008-3731"             , "3bd 2 ba", "https://assets.themortgagereports.com/wp-content/uploads/2017/12/How-to-Buy-a-House-with-Low-Income-This-Year.jpg","For Sale"     ,false,true  ,false)
